// elevation shadow, based of material design
// todo: improve shadows a bit, material shadows are not super sexy
...
export const getShadow = (elevation) => {
	...
	// test if elevation exist
	if (!elevation || !Object.keys(elevationShadow).includes(elevation)) {
		throw new Error(`Elevation ${elevation} does not exist`)
	}
